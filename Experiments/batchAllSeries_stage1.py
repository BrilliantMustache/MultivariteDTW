...
datasetsNameFile = pathUCRResult+"datasets_node"+hostname+"_stage1.txt"
datasetsSizeFile = pathUCRResult+"datasets_size_node"+hostname+"_stage1.txt"
...
with open(logfile, 'a+') as f:
    f.write('Node '+hostname+' : '+ ",".join(alldatasets)+" . Stage 1.")
