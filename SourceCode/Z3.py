...
def DTWDistanceWindowLB_Ordered_Z3 (queryID, DTWdist, K, Q, query, references, W, TH=0):
    '''
...
def dataCollection(datapath, maxdim = 5, nqueries = 3, nreferences = 20, windows = [20], Ks=[6], Qs=[2], TH=0):
    datasets = []
...
if __name__ == '__main__':
    ...
    coreTime_g = 0
    TH_g=0
    dataCollection(datapath, maxdim_g,nqueries_g,nreferences_g,windows_g,Ks_g,Qs_g,TH_g)
