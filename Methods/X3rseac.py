...
from Methods.X3r  import findBoxes_onepoint
from Methods.X3r  import inBoxes
import time
...
def DTWDistanceWindowLB_Ordered_X3rseac_ (X0LBs, bboxes, s1, refs, W, distances, qid, C, TH=1):
    '''
