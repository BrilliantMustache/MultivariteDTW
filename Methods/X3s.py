...
def DTWDistanceWindowLB_Ordered_X3s_ (queryID, X0LBs, DTWdist, bboxes, K, Q, s1, refs, W, TH=1):
    ...
    for x in range(1, len(LBSortedIndex)):
        if X0LBs[LBSortedIndex[x]] > dist:
            ...
            c_lb = getLB_oneQR_boxR(s1, bboxes[LBSortedIndex[x]])
            cluster_cals += 1
            if c_lb <= dist:
...
#    datasets=["ArticularyWordRecognition","AtrialFibrillation"]
    ...
    np.save(pathUCRResult + '_AllDataSets/' + 'd' + str(maxdim) + "/" + str(nqueries) + "X" + str(nreferences)
            + "_X3s_w" + intlist2str(windows) +"K" + intlist2str(Ks)+ "Q" + intlist2str(Qs) + "_setuptimes.npy", allsetupTimes)
    return 0
...
#    datasets = ["ArticularyWordRecognition", "AtrialFibrillation"]
    ...
    np.save(pathUCRResult + "_AllDataSets/" + 'd' + str(maxdim) + '/' + str(nqueries) + "X" + str(nreferences) +
            "_X3s_w" + str(window) + "K" + intlist2str(Ks) + "Q" + intlist2str(Qs) + '_speedups.npy', speedups)
    np.save(pathUCRResult + "_AllDataSets/" + 'd' + str(maxdim) + '/' + str(nqueries) + "X" + str(nreferences) +
            "_X3s_w" + str(window) + "K" + intlist2str(Ks) + "Q" + intlist2str(Qs) + '_skipschosen.npy', skips_chosen)
    np.save(pathUCRResult + "_AllDataSets/" + 'd' + str(maxdim) + '/' + str(nqueries) + "X" + str(nreferences) +
            "_X3s_w" + str(window) + "K" + intlist2str(Ks) + "Q" + intlist2str(Qs) + '_settingchosen.npy', setting_chosen)
    np.save(pathUCRResult + "_AllDataSets/" + 'd' + str(maxdim) + '/' + str(nqueries) + "X" + str(nreferences) +
            "_X3s_w" + str(window) + "K" + intlist2str(Ks) + "Q" + intlist2str(Qs) + '_overheadrate.npy', overheadrate)
